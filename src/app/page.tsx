...
import { Compass, HelpCircle, Map, ShieldCheck, Tent } from "lucide-react";
  ...
  return <div className="space-y-8">
    <section className="rounded-2xl bg-gradient-to-br from-green-600 to-emerald-800 p-8 text-white">
      <div className="flex items-start gap-4">
        ...
        <div>
          <h1 className="text-3xl font-bold tracking-tight">Know the route. Know the risks. Know how you&apos;re getting home.</h1>
          <p className="mt-2 max-w-2xl text-green-50">Hike is safety-first wilderness decision support: plan intelligently, prepare offline, navigate confidently, and keep a backup plan when conditions change.</p>
