...
export function watchMethodHeading(
  ...
  // A non-finite or out-of-range hour must not yield a confident heading: this
  // is the method someone falls back on when they have no compass at all.
  if (
    !Number.isFinite(hourSolar) ||
